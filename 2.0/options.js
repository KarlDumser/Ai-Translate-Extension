...
(async () => {
  ...
  const i18n = {
    de: {
      ...
      modeHint: 'Hover: Sofort beim Überfahren. Select: Wort markieren + Button. Auto-Select: Markieren → sofort, kein Hover.',
      modeHover: 'Hover (sofort)',
      modeSelect: 'Select (mit Button)',
      modeAutoSelect: 'Auto-Select (sofort, kein Hover)',
    ...
    en: {
      title: '⚙ JPN-EN Settings',
        ...
        modeHint: 'Hover: Translate instantly. Select: Mark word + button. Auto-Select: Mark → instant, no hover.',
        modeHover: 'Hover (instant)',
        modeSelect: 'Select (with button)',
        modeAutoSelect: 'Auto-Select (instant, no hover)',
    ...
    ja: {
      title: '⚙ JPN-EN 設定',
        modeLabel: '翻訳モード',
        modeHint: 'ホバー：ホバーする際に即座に翻訳します。セレクト：単語をマーク+ボタン。オートセレクト：マーク→即座、ホバーなし。',
        modeHover: 'ホバー (即座)',
        modeSelect: 'セレクト (ボタン付き)',
        modeAutoSelect: 'オートセレクト (即座、ホバーなし)',
      sourceLabel: '翻訳対象言語',
